class CaseOne extends Phaser.Scene {
    constructor() {
        super("caseOne");
    }
    ...
    preload(){
        this.load.image('firstPortrait', 'assets/firstPortrait.png');
    ...
    create() {
        ...
        this.bg = this.add.tileSprite(0,0, game.config.width, game.config.height, 'firstPortrait').setOrigin(0,0);
        ...
        var glitch = this.add.sprite(710, 40, 'glitchOne').setInteractive();
        glitch.setAlpha(0);
