class Execution extends Phaser.Scene {
    constructor() {
        super("execution");
    }
    ...
    preload(){
        this.load.image('executionPortrait', 'assets/executionPortrait.png');
    ...
    create() {
        ...
        this.bg = this.add.tileSprite(0,0, game.config.width, game.config.height, 'executionPortrait').setOrigin(0,0);
        ...
        var glitch = this.add.sprite(860, 285, 'glitchOne').setInteractive();
        glitch.setAlpha(0);
        ...
        glitch.on('pointerdown', function (pointer) {
            ...
            if(deathTimeFound == false){
                deathTimeQuestion = true;
                answered = answered + 1;
