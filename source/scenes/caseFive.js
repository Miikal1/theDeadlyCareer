class CaseFive extends Phaser.Scene {
    constructor() {
        super("caseFive");
    }
    ...
    preload(){
        this.load.image('fifthPortrait', 'assets/fifthPortrait.png');
    ...
    create() {
        ...
        this.bg = this.add.tileSprite(0,0, game.config.width, game.config.height, 'fifthPortrait').setOrigin(0,0);
        ...
        var glitch = this.add.sprite(350, 90, 'glitchOne').setInteractive();
        glitch.setAlpha(0);
