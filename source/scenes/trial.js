class Trial extends Phaser.Scene {
    ...
    preload(){
        this.load.image('trialPortrait', 'assets/trialPortrait.png');
    ...
    create() {
        ...
        this.bg = this.add.tileSprite(0,0, game.config.width, game.config.height, 'trialPortrait').setOrigin(0,0);
        ...
        var glitch = this.add.sprite(275, 385, 'glitchOne').setInteractive();
        glitch.setAlpha(0);
