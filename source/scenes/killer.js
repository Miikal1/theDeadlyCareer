class Killer extends Phaser.Scene {
    constructor() {
        super("killer");
    }
    ...
    preload(){
        this.load.image('killerPortrait', 'assets/killerPortrait.png');
    ...
    create() {
        ...
        this.bg = this.add.tileSprite(0,0, game.config.width, game.config.height, 'killerPortrait').setOrigin(0,0);
        ...
        var glitch = this.add.sprite(650, 170, 'glitchOne').setInteractive();
        glitch.setAlpha(0);
