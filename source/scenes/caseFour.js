class CaseFour extends Phaser.Scene {
    constructor() {
        super("caseFour");
    }
    ...
    preload(){
        this.load.image('fourthPortrait', 'assets/fourthPortrait.png');
    ...
    create() {
        ...
        this.bg = this.add.tileSprite(0,0, game.config.width, game.config.height, 'fourthPortrait').setOrigin(0,0);
        ...
        var glitch = this.add.sprite(775, 220, 'glitchOne').setInteractive();
        glitch.setAlpha(0);
